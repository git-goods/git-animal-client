...
async function CreateQuizPage() {
  ...
  return (
    <div className="w-full h-full min-h-[calc(100vh_-_var(--mobile-header-height))] p-[12px_16px] bg-gray-050">
      <div className="relative flex flex-col justify-center items-center w-full h-[44px]">
        <h1 className="glyph18-bold font-['Product_Sans'] font-bold text-white">
