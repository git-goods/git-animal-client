...
export function TabItem({ isSelected, label, path }: { isSelected?: boolean } & TabItemType) {
  ...
  const selectedStyle = cn(baseStyle, 'text-white', 'max-mobile:text-white/75 max-mobile:bg-white/10');

  const nonSelectedStyle = cn(baseStyle, 'text-white/25', 'max-mobile:text-white/25');
