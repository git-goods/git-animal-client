...
function ArcadeComponent() {
  ...
  const { powerStateAtom, togglePowerAtom, gameStateAtom, handleButtonPressAtom } = useArcadeAtoms();

  const [{ isPowered }] = useAtom(powerStateAtom);
  const [{ activeGame }] = useAtom(gameStateAtom);
    ...
    <div className={containerStyle}>
      ...
      <ScreenWrapperSvg>
        ...
        <foreignObject x="280" y="510" width="1100" height="965">
          <ScreenContent joystickDirection={joystickDirection} />
        </foreignObject>
