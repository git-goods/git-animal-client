...
export const container = cn('w-fit h-fit mx-auto rounded-2xl bg-white/10');
...
export const sliderContainer = cn('relative w-[1120px] h-[800px]', 'max-mobile:w-[calc(100vw-40px)] max-mobile:h-auto');
