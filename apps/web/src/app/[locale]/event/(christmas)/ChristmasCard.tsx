    ...
    <div className="[&_.animal-card-type]:text-black [&_.animal-card-rating]:text-black">
      <div className="animal-card-container relative w-[265px] h-[328px]">
        <div className="absolute top-0 left-0 w-full h-full z-0">
          <img src="/event/christmas/card-bg-christmas.webp" alt="EX" width={265} height={328} draggable={false} />
        </div>
        <div className="absolute top-4 left-4 right-4 z-[1]">
          <img src="/event/christmas/unknown-rate.webp" alt="EX" width={233} height={233} draggable={false} />
        </div>
        <div className="absolute top-4 left-4 right-4 z-[1]">
        ...
        <div className="animal-card-info absolute bottom-5 left-5 right-5 flex justify-between gap-2">
          ...
          <p className="animal-card-rating font-product text-glyph-22 leading-10">
            <Image src="/event/christmas/christmas-icon.webp" width={32} height={39} alt="christmas" />
          </p>
        </div>
      </div>
    </div>
