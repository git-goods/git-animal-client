  ...
  return (
    <button
      ...
      className={cn(
        ...
        disabled ? 'w-[36px] h-[36px]' : 'w-[40px] h-[40px]',
        disabled ? 'mobile:w-[24px] mobile:h-[24px]' : 'mobile:w-[26px] mobile:h-[26px]',
      )}
    >
      {disabled ? (
...
const arrowStyle =
  'absolute top-0 bottom-[64px] m-auto z-[2] [&_img]:w-full [&_img]:h-full mobile:bottom-[72px]';
